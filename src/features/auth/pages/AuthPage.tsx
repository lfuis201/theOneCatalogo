  ...
  if (loading) {
    return (
      <div className="h-screen w-full flex flex-col items-center justify-center bg-white gap-4">
        ...
        <p className="text-primary/70 font-medium animate-pulse">Cargando experiencia...</p>
      </div>
    );
  }
        ...
        <div className="relative z-10 p-16 flex flex-col justify-end h-full text-white">
          <div>
            ...
            <p className="text-white/90 text-xl max-w-md font-medium">
              Gestiona tu proyecto con herramientas de última generación y una interfaz intuitiva.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-2/5 flex flex-col items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[380px] space-y-10">
          <div className="space-y-3">
            <h1 className="text-5xl font-black tracking-tight text-primary">Bienvenido</h1>
            <p className="text-default-500 text-lg font-medium">Panel de administración central</p>
          </div>
